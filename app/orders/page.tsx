...
export default function Orders() {
  ...
  return (
    <div className="flex flex-col w-full h-[calc(100vh-52px)] overflow-y-auto p-4">
      <div className="flex flex-col items-center w-full max-w-4xl space-y-4">
        <div className="flex justify-between w-[326px] items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <h1 className="text-[25px] ml-2 font-bold">Orders</h1>
          </Link>
